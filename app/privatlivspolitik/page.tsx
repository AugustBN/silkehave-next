    ...
    <>
      ...
      <section className="starticle">
        <div className="starticle-inner">
          ...
          <p>Vi gemmer dine oplysninger så længe vi arbejder for dig, og 5 år efter den sidste opgave — det er fordi bogføringsloven kræver det.</p>
          ...
          <p>
            Du kan også klage til Datatilsynet — se <a href="https://www.datatilsynet.dk" target="_blank" rel="noopener noreferrer">datatilsynet.dk</a>.
          </p>
