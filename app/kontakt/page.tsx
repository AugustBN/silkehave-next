...
export const metadata: Metadata = {
  title: "Kontakt & tilbud",
  description: "Få et tilbud fra SilkeHave. Vi kører i Silkeborg og hele Midtjylland. Hækklipning, fliserens, vinduesrens og snerydning. Fast pris inden vi starter.",
  alternates: { canonical: "https://silkehave.dk/kontakt" },
  openGraph: {
    title: "Kontakt & tilbud | SilkeHave",
    ...
    <>
      ...
      <section className="page-head">
        <div className="page-head-inner">
          ...
          <h1>Få et tilbud.</h1>
          <p>Skriv kort hvad du har brug for. Vi vender tilbage inden for 1-2 hverdage med en fast pris. Du binder dig ikke til noget.</p>
        </div>
      </section>
      ...
      <section style={{ background: "var(--cream)" }}>
        <div className="kontakt-grid">
          <div className="kontakt-info">
            ...
            <p>Hvis det er nemmere, så skriv på Facebook. Vi svarer typisk samme dag.</p>
