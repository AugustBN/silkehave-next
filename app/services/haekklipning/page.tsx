...
export const metadata: Metadata = {
  ...
  description: "Professionel hækklipning i Silkeborg og omegn. Fast pris, præcist arbejde, rydder op efter os.",
};
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <AnimateIn>
          ...
          <p className="text-xl leading-relaxed" style={{ color: "var(--color-muted)" }}>
            Præcis klipning af alle typer hækplanter. Vi sørger for et pænt resultat og rydder altid op efter os.
          </p>
        </AnimateIn>
        <AnimateIn delay={0.15} className="mt-10 flex gap-4">
          ...
          <a href="tel:+4591251021" className="rounded-full border px-7 py-3.5 font-500 transition-all hover:bg-green-light" style={{ fontWeight: 500, borderColor: "rgba(61,107,53,0.25)", color: "var(--color-green-dark)" }}>
            Ring til os
          </a>
        </AnimateIn>
      </div>
